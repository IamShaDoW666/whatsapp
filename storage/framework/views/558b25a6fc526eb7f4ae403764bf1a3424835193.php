                ...
                <div class="col-lg-3 col-md-4 col-sm-6 py-2">
                    <div class="plan-2">
                        ...
                        <ul class="plan-detail">
                            <li><?php echo e(($plan->max_products < 0) ? __('Unlimited'):$plan->max_products); ?> <?php echo e(__('Products')); ?></li>
                            <li><?php echo e(($plan->max_stores < 0) ? __('Unlimited'):$plan->max_stores); ?> <?php echo e(__('Stores')); ?></li>
                        </ul>
...
<?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/custom_landing_page/plan-section.blade.php ENDPATH**/ ?>