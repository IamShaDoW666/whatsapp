            ...
            <div class="row text-center text-sm-left align-items-sm-center">
                ...
                <div class="col-sm-6 mb-md-0">
                    <ul class="nav justify-content-center justify-content-md-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('change.mode')); ?>"><?php echo e((Auth::user()->mode == 'light') ? __('Light Mode') : __('Dark Mode')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/layouts/admin.blade.php ENDPATH**/ ?>