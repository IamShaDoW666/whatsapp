...
<div class="modal right fade" tabindex="-1" role="dialog" aria-labelledby="setting-modal-label" id="setting-modal-section-9">
                    ...
                    <div class="card mb-2">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div id="menu"></div>
                                    <!-- <button type="button" class="btn btn-info" onclick="add_new_input('setting-modal-section-9')"><i class="fa fa-plus"></i></button> -->
                                </div>
                            </div>
                        </div>
                    </div>
...
</div><?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/custom_landing_page/custome-social-links.blade.php ENDPATH**/ ?>