                ...
                <div class="card card-fluid">
                    ...
                    <div class="card-body text-center <?php echo e(!empty(\Auth::user()->type != 'super admin')?'plan-box':''); ?>">
                        ...
                        <?php if(\Auth::user()->type=='Owner' && \Auth::user()->plan == $plan->id): ?>
                            <h5 class="h6 my-4">
                                <?php echo e(__('Expired : ')); ?> <?php echo e(\Auth::user()->plan_expire_date ? \App\Utility::dateFormat(\Auth::user()->plan_expire_date):__('Unlimited')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/plans/index.blade.php ENDPATH**/ ?>