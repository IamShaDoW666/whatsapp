    ...
    <div class="min-vh-100 h-100vh py-5 d-flex align-items-center bg-gradient-danger">
        ...
        <div class="container position-relative zindex-100">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <h6 class="display-1 mb-3 font-weight-600 text-white"><?php echo e(__('500')); ?></h6>
                    <p class="lead text-lg text-white mb-5">
                        <?php echo e(__("Sorry something has gone wrong on the websites server.")); ?>
...
<?php echo $__env->make('errors::minimal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/errors/500.blade.php ENDPATH**/ ?>