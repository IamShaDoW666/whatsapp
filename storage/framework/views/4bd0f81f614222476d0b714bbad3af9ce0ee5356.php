<?php
    ...
    $user         = \Auth::user();
    $plan         = \App\Plan::where('id', $user->plan)->first();
?>
<nav class="navbar navbar-main navbar-expand-lg navbar-dark bg-primary navbar-border" id="navbar-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-fade" id="navbar-main-collapse">
                    ...
                    <li class="nav-item dropdown dropdown-animate" data-toggle="hover">
                        ...
                        <div class="dropdown-menu dropdown-menu-arrow p-lg-0">
                            ...
                            <div class="p-lg-4">
                                ...
                                <?php if(isset($plan) && $plan->shipping_method == 'on'): ?>
            ...
            <!-- Right menu -->
            <ul class="navbar-nav ml-lg-auto align-items-center d-none d-lg-flex wsdb vhdasgvc">
                <?php if(Auth::user()->type == 'Owner'): ?>
                    <li class="nav-item dropdown dropdown-animate">
                        <a class="nav-link pr-lg-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/partials/admin/header.blade.php ENDPATH**/ ?>