...
<div>
    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row collection-items <?php echo e(($loop->iteration != 1) ? 'd-none' : ''); ?> <?php echo e($loop->iteration-1); ?><?php echo str_replace(' ', '_', __($key)); ?> product_tableese">
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-sm-6 col-md-6 col-xl-3 product_item" data-name="<?php echo e($product->name); ?>">
                    <div class="product-card">
                        <a href="#" data-size="lg" data-url="<?php echo e(route('store.product.product_view',[$store->slug,$product->id])); ?>" data-title="<?php echo e($product->name); ?>" data-ajax-popup="true" class="product_details_icon float-right"><i class="fas fa-eye product_details_active text_color"></i></a>
                        <div class="product-image">
                            <a href="#" data-size="lg" data-url="<?php echo e(route('store.product.product_view',[$store->slug,$product->id])); ?>" data-title="<?php echo e($product->name); ?>" data-ajax-popup="true">
                                <?php if(!empty($product->is_cover)): ?>
                                    <img alt="Image placeholder" src="<?php echo e(asset(Storage::url('uploads/is_cover_image/'.$product->is_cover))); ?>" width="70px">
                                <?php else: ?>
                                    <img alt="Image placeholder" src="<?php echo e(asset(Storage::url('uploads/is_cover_image/default.jpg'))); ?>" width="70px">
                                <?php endif; ?>
                            </a>
                        </div>
                        <div class="product-detail">
                            ...
                            <div class="item-spin">
                                <?php if($product->enable_product_variant == 'on'): ?>
                                    <p class="price-spin"><?php echo e(__('In Variant')); ?></p>
                                <?php else: ?>
                                    <p class="price-spin"><?php echo e(\App\Utility::priceFormat($product->price)); ?></p>

                                <?php endif; ?>
                            </div>
                            <?php if($product->enable_product_variant == 'on'): ?>
                                <a href="#" class="btn btn-addcart" data-size="md" data-url="<?php echo e(route('store-variant.variant',[$store->slug,$product->id])); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Add Variant')); ?>"><?php echo e(__('ADD TO CART')); ?>
...
<?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/storefront/grid.blade.php ENDPATH**/ ?>