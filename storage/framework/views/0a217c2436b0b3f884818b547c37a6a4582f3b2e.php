...
<head>
    ...
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
        <title><?php echo e((Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'Whatsstore Saas')); ?></title>
...
<script type="text/javascript">
                                    ...
                                    tab_collaps_html +=`<form enctype="multipart/form-data" id="form_system_new_content_${li_id}">
                                                <div class="col-lg-12">
                                                    <div class="tab-modal-img">
                                                        ...
                                                        <img alt="data-1" src="<?php echo e(asset('landing/images/default-thumbnail.jpg')); ?>" id="system_img_new_content_${li_id}">
    ...
    function add_content(id){
        ...
        $.ajax({
            type:'POST',
            url: '<?php echo e(url("/LandingPage/setConetent")); ?>',
            data: formData,
            contentType: false,
            processData: false,
            success:function(data){
                if(data == "error"){
                    ...
                    modalHide();
                    $(`.section_div_${id}`).load(`<?php echo e(url("/get_landing_page_section")); ?>/${view_name}`, function() {
                        ...
                        show_content(id);
                        $(`#setting-modal-section-${id}`).find('#save').click(function() {add_content(id)});
                        $(`#${id}`).find('#delete').click(function() {delete_content(id)});
                    });
                }
    ...
    function delete_content(id){
        ...
        $.ajax({
            type:'POST',
            url: `<?php echo e(url("/LandingPage/removeSection")); ?>/${id}`,
            success:function(data){
                if(data == "error"){
                    show_toastr('<?php echo e(__("Error")); ?>', '<?php echo e(__("Something went wrong.")); ?>', 'error');
                }else{
    ...
    function copySection(arg){
        ...
        $.ajax({
            type:'POST',
            url: '<?php echo e(url("/LandingPage/copySection")); ?>',
            data: {id:id},
            success:function(data){
                if(data == "error"){
                    show_toastr('<?php echo e(__("Error")); ?>', '<?php echo e(__("Something went wrong.")); ?>', 'error');
    ...
    <?php if(count($get_section) > 0): ?>
        <?php $__currentLoopData = $get_section; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($value->content != "" && $value->content != null): ?>
                <div class="section_div_<?php echo e($value->id); ?> tooltip1 ui-widget-content" id="<?php echo e($value->id); ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php if(count($get_section) > 0): ?>
                    <?php $__currentLoopData = $get_section; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($value->content == "" || $value->content == null): ?>
                            <img src="<?php echo e(asset('storage/Landing_page_component_image')); ?>/<?php echo e($value->section_demo_image); ?>" onclick="set_section_page('<?php echo e($value->id); ?>')" id="component_modal_<?php echo e($value->id); ?>">
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </div>
...
<script type="text/javascript">
    $("#sortablediv").sortable({
        ...
        stop: function( event, ui )
        {
            ...
            $.ajax({
                type:'POST',
                url: '<?php echo e(url("/LandingPage/setOrder")); ?>',
...
<?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/custom_landing_page/index.blade.php ENDPATH**/ ?>