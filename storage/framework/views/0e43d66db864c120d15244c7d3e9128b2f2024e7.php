                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('product_tax[]', $product_tax,null, array('class' => 'form-control','data-toggle'=>'select','data-toggle'=>'select','multiple','required'=>'required'))); ?>
                            ...
                            <div class="col-6 proprice">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('price',null,array('class'=>'form-control','placeholder'=>__('Enter Price ')))); ?>
                            ...
                            <div class="col-6 proprice">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('quantity',null,array('class'=>'form-control','placeholder'=>__('Enter Quantity'),'required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/product/create.blade.php ENDPATH**/ ?>