                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h5 font-weight-bold text-white mb-0"><?php echo e(\App\Utility::priceFormat($totle_sale)); ?></span>
                                </div>
                                <div class="col-auto">
                                    ...
                                    <?php $__currentLoopData = $item_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($product->id == $item): ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div>
                                                        <span class="completion mr-2 text-dark text-right "><?php echo e(\App\Utility::priceFormat($product->price)); ?></span>
                                                    </div>
                                    ...
                                    <?php $__currentLoopData = $new_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($order->status != 'Cancel Order'): ?>
                                            <tr>
                                                ...
                                                <td class="order">
                                                    <span class="h6 text-sm font-weight-bold mb-0"><?php echo e(\App\Utility::dateFormat($order->created_at)); ?></span>
                                                </td>
                                                <td>
                                                    <span class="client"><?php echo e($order->name); ?></span>
                                                </td>
                                                <td>
                                                    <span class="value text-sm mb-0"><?php echo e(\App\Utility::priceFormat($order->price)); ?></span>
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end">
                                                        ...
                                                        <span class="btn-inner--icon">
                                                         <?php if($order->status == 'pending'): ?>
                                                            ...
                                                            <?php echo e(__('pending')); ?>: <?php echo e(\App\Utility::dateFormat($order->created_at)); ?>

                                                                    <?php else: ?>
                                                        </span><span class="btn-inner--text">
                                                            <?php echo e(__('Delivered')); ?>: <?php echo e(\App\Utility::dateFormat($order->updated_at)); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/home.blade.php ENDPATH**/ ?>