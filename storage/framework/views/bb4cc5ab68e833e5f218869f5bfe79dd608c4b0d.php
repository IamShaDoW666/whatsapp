    ...
    <div class="container">
        <div class="row top-bar">
            ...
            <div class="col-lg-6 col-md-6 right-part">
                <ul>
                    <li>
                        <a href="<?php echo e(route('login')); ?>" class="button" id="button"></a>
                    </li>
                    <li>
...
<?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/custom_landing_page/custome-top-header-section.blade.php ENDPATH**/ ?>