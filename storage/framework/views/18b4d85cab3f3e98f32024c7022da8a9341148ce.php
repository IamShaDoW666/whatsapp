                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12" id="logo">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="text_value" id="text" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\whatsapp\resources\views/custom_landing_page/custome-footer-section.blade.php ENDPATH**/ ?>