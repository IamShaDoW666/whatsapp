...
class SettingController extends Controller
{
    ...
    public function index()
    {
        ...
        else
        {
            ...
            if($store_settings)
            {
                ...
                return view('settings.index', compact('settings', 'store_settings', 'plan', 'serverIp', 'subdomain_name'));
            }
            else
            {
    ...
    public function saveBusinessSettings(Request $request)
    {
        ...
        if(\Auth::user()->type == 'super admin')
        {
            ...
            if(!empty($request->title_text) || !empty($request->footer_text) || !empty($request->default_language) || !empty($request->display_landing_page))
            {
                $post = $request->all();
