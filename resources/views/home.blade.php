                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h5 font-weight-bold text-white mb-0">{{\App\Utility::priceFormat($totle_sale)}}</span>
                                </div>
                                <div class="col-auto">
                                    ...
                                    @foreach($item_id as $k => $item)
                                        @if($product->id == $item)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div>
                                                        <span class="completion mr-2 text-dark text-right ">{{\App\Utility::priceFormat($product->price)}}</span>
                                                    </div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end">
                                                        ...
                                                        <span class="btn-inner--icon">
                                                         @if($order->status == 'pending')
                                                            ...
                                                            {{__('pending')}}: {{\App\Utility::dateFormat($order->created_at)}}
                                                                    @else
