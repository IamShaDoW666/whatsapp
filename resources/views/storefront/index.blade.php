...
<head>
    ...
    <title>{{__('Home')}} - {{($store->tagline) ?  $store->tagline : config('APP_NAME', ucfirst($store->name))}}</title>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/sites.css')}}" id="stylesheet">
    @if(!empty($store->store_theme))
        <link rel="stylesheet" href="{{asset('assets/css/'.$store->store_theme)}}" id="stylesheet">
    @else
        <link rel="stylesheet" href="{{asset('assets/css/style.css')}}" id="stylesheet">
    @endif
        ...
        <nav class="navbar header-navbar navbar-expand floating-nav align-items-center">
            <div class="navbar-container d-flex align-items-center">
                <a href="#" class="nav-brand nav-logo">
                    <img src="{{asset(Storage::url('uploads/store_logo/').(!empty($store->logo)?$store->logo:'logo.png'))}}" class="header_img" width="200px" style="margin:15px 40px;">
                </a>
                ...
                <form class="search-input" action="/action_page.php">
                    <a href="#" class="search-icon">
                        <img src="{{asset('assets/images/search-icon-black-body.svg')}}" alt="#">
                    </a>
                ...
                <div class="row match-height">
                                    ...
                                    <div class="filter-by">
                                        ...
                                        <div class="dropdown price-dropdown">
                                            <a class="px-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-offset="0,10">
                                                <span>{{__('Price')}} <img src="{{asset('assets/images/select-arrow.png')}}" alt=""/></span>
                                            </a>
                    ...
                    <div class="col-xl-4">
                                            ...
                                            @if($product['variant_id'] != 0 )
                                                <div class="checkout-items">
                                                    ...
                                                    <div class="customer-name">
                                                        ...
                                                        <span class="detail-qty pr-1">x{{$product['quantity']}}</span>
                                                        @php
                                                            $total_tax=0;
                                                        @endphp
                                                        @if($product['tax'] > 0)
                                                    ...
                                                    <div class="item-spin" data-id="{{$key}}">
                                                        <button class="spin-rupes product_qty" data-id="{{$product['id']}}" type="submit" value="{{$product['quantity']}}" data-option="decrease">
                                                            <img src="{{asset('assets/images/minus-icon.svg')}}" alt="#" width="15px">
                                                        </button>

                                                        <input type="hidden" class="pro_variant_id" data-id="{{$product['variant_id']}}" id="product_qty">
                                                        <p class="price-spin">{{\App\Utility::priceFormat($product['variant_price']* $product['quantity'])}}</p>

                                                        <button class="spin-rupes product_qty" data-id="{{$product['id']}}" type="submit" value="{{$product['quantity']}}" data-option="increase">
                                                            <img src="{{asset('assets/images/pluse-icon.svg')}}" alt="#" width="15px">
                                                        </button>
                                                    </div>
                                                </div>
                                            @else
                                                <div class="checkout-items">
                                                    ...
                                                    <div class="item-spin" data-id="{{$key}}">
                                                        ...
                                                        <input type="hidden" class="pro_variant_id" data-id="{{$product['variant_id']}}" id="product_qty">
                                                        <p class="price-spin">{{\App\Utility::priceFormat($product['price']* $product['quantity'])}}</p>
                                        ...
                                        <ul class="invoice-list">
                                            <li class="invoice-detail">
                                                ...
                                                <div class="invoice-amt font-weight600 sub_total_price" data-value="{{$total}}">
                                                    {{App\Utility::priceFormat($sub_total)}}
                                                </div>
                                            </li>
                                            <li class="invoice-detail">
                                                <div class="invoice-title">
                                            ...
                                            @foreach($taxArr['tax'] as $k=>$tax)
                                                <li class="invoice-detail">
                                                    ...
                                                    <div class="invoice-amt">
                                                        <span class="invoice-amt font-weight-bold">{{\App\Utility::priceFormat($taxArr['rate'][$k])}}</span>
                                                    </div>
                                                </li>
                                            @endforeach
                                            ...
                                            <li class="invoice-detail" id="Subtotal">
                                                ...
                                                <div class="invoice-amt total-amount">
                                                    ...
                                                    <div class="final_total_price pro_total_price" data-original="{{\App\Utility::priceFormat(!empty($total)?$total:0)}}">
                                                        {{App\Utility::priceFormat($total)}}
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="invoice-details">
                                        <ul class="invoice-list">
                                            ...
                                            <li class="invoice-detail">
                                                ...
                                                <div class="invoice-amt total-amount pro_total_price" data-original="{{\App\Utility::priceFormat(!empty($total)?$total:0)}}">
                                                    0.00
                                                </div>
                                            </li>
                                        </ul>
                        ...
                        <div class="row">
                            ...
                            @endif
                            @if($store->telegrambot && $store->telegramchatid)
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="card telegram-card">
                                        <button type="submit" class="btn telegram-btn pt-2" id="owner-telegram">
                                            <img src="{{asset('assets/images/telegram.svg')}}" alt="#" width="50px">
...
<script src="{{asset('assets/js/sitejs.core.js')}}"></script>
